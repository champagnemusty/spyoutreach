    ...
    <div className="space-y-6">
      ...
      <LuxuryCard className="p-0">
        <div
          ...
          className={`flex cursor-pointer flex-col items-center justify-center gap-3 rounded-xl px-6 py-14 text-center transition-all duration-300 ${
            isDragging ? "bg-surface-hover shadow-[0_0_60px_-15px_var(--accent)]" : ""
          }`}
        >
          <input
            ref={inputRef}
      ...
      <LuxuryCard className="space-y-2 px-4 py-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <ShimmerButton onClick={handleClean} disabled={!file || isSubmitting}>
